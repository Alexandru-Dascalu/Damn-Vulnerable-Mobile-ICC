...
class MessagesProviderHigh : ContentProvider() {
    ...
    private val uriMatcher = UriMatcher(UriMatcher.NO_MATCH).apply {
        addURI("uk.ac.swansea.dascalu.dvmicc.whatsapp.providerHigh", "chats", 1)
        addURI("uk.ac.swansea.dascalu.dvmicc.whatsapp.providerHigh", "chat/*", 2)
    }

    companion object Contract {
        val CHATS_URI = Uri.parse("content://uk.ac.swansea.dascalu.dvmicc.whatsapp.providerHigh/chats")
        val CHAT_URI = Uri.parse("content://uk.ac.swansea.dascalu.dvmicc.whatsapp.providerHigh/chat/")
